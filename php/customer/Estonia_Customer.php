            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Application form - Completed, signed twice by the applicant. If the applicant is a minor, visa application signed twice by legal guardian (Proving the custody of a minor child, apostilled birth certificate, divorce papers etc)
                        ...
                        <a href="https://eelviisataotlus.vm.ee/" class="doc-link-special">Download Application Form</a>
                        <a href="https://newdelhi.mfa.ee/wp-content/uploads/sites/41/2023/09/Checklist-Tourism-1.pdf"class="doc-link-special">Download Document Checklist</a>
                        <?php else: ?>
                            ...
                            <p>
                                ...
                                ?>
                                <a href="/payments/payment.php?country=estonia&visa_type=eligibility_check"><button id="check-now" class="doc-link-special">Check Eligibility - Pay ₹499</button></a>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (isset($_SESSION['user_id'])): ?>
                        <!-- Special links for logged-in users -->
                        <a href="https://newdelhi.mfa.ee/" class="doc-link-special">Download Application Form</a>
                        <a href="https://newdelhi.mfa.ee/wp-content/uploads/sites/41/2023/09/Checklist-Tourism-1.pdf" class="doc-link-special">Download Document Checklist</a>
                        <?php else: ?>
