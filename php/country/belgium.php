...
?>
    ...
    <a href="/payments/payment.php?country=belgium&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php else: ?>
    <p><small>Please <a href="/php/login.php?redirect_to=/php/belgium.php" class="login-link">login</a> to proceed with payment</small></p>
    <a href="/payments/payment.php?country=belgium&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php endif; ?>
...
<?php else: ?>
    <a href="/payments/payment.php?country=belgium&visa_type=eligibility_check" class="check-btn">Download Documents</a>
<?php endif; ?>
