...
$token = base64_encode(json_encode([
    ...
    <a href="/payments/payment.php?country=turkey&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php else: ?>
    <p><small>Please <a href="/php/login.php?redirect_to=/php/turkey.php" class="login-link">login</a> to proceed with payment</small></p>
    <a href="/payments/payment.php?country=turkey&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php endif; ?>
            </div>
        </div>
...
<?php else: ?>
    <a href="/payments/payment.php?country=turkey&visa_type=eligibility_check" class="check-btn">Download Documents</a>
<?php endif; ?>
...
<section class="visa-cards-wrapper" id="eVisa">
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="/payments/payment.php?country=turkey&visa_type=tourist_01"><button class="apply-button">Apply Now for $49 (₹4,200 + ₹499)</button></a>
                    <?php else: ?>
                        <a href="/payments/payment.php?country=turkey&visa_type=tourist_01&redirect_to=/php/turkey.php"><button class="apply-button">Apply Now for $49 (₹4,200 + ₹499)</button></a>
                    <?php endif; ?>
    </div>
        ...
        <div class="container">
            ...
            <div class="visa-card">
                ...
                <div class="visa-action">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                    <a href="/payments/payment.php?country=turkey&visa_type=tourist_02"><button class="start-btn">Apply Now</button></a>
                    <?php else: ?>
                        <a href="/payments/payment.php?country=turkey&visa_type=tourist_02&redirect_to=/php/turkey.php"><button class="start-btn">Apply Now</button></a>
                    <?php endif; ?>
                </div>
            </div>
