...
$token = base64_encode(json_encode([
    ...
    <a href="/payments/payment.php?country=morocco&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php else: ?>
    <p><small>Please <a href="/php/login.php?redirect_to=/php/morocco.php" class="login-link">login</a> to proceed with payment</small></p>
    <a href="/payments/payment.php?country=morocco&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php endif; ?>
            </div>
        </div>
...
<?php else: ?>
    <a href="/payments/payment.php?country=morocco&visa_type=eligibility_check" class="check-btn">Download Documents</a>
<?php endif; ?>
    ...
    <div class="visa-cards-grid">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="/payments/payment.php?country=morocco&visa_type=tourist_01"><button class="apply-button">Apply Now for $90.80 (₹7300 + ₹499)</button></a>
                    <?php else: ?>
                        <a href="/payments/payment.php?country=morocco&visa_type=tourist_01&redirect_to=/php/morocco.php"><button class="apply-button">Apply Now for $90.80 (₹7300 + ₹499)</button></a>
                    <?php endif; ?>
        </div>
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="/payments/payment.php?country=morocco&visa_type=tourist_02"><button class="apply-button">Apply Now for $128.13 (₹10,500 + ₹499)</button></a>
                    <?php else: ?>
                        <a href="/payments/payment.php?country=morocco&visa_type=tourist_02&redirect_to=/php/morocco.php"><button class="apply-button">Apply Now for $128.13 (₹10,500 + ₹499)</button></a>
                    <?php endif; ?>
        </div>
