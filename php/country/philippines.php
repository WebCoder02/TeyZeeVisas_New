...
$token = base64_encode(json_encode([
    ...
    <a href="/payments/payment.php?country=phillippines&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php else: ?>
    <p><small>Please <a href="/php/login.php?redirect_to=/php/phillippines.php" class="login-link">login</a> to proceed with payment</small></p>
    <a href="/payments/payment.php?country=phillippines&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php endif; ?>
            </div>
        </div>
    ...
    <section class="document-checklist">
        <div class="container">
             <div class="label-container">
               ...
               <?php if (isset($_SESSION['user_id'])): ?>
    <a href="../php/Phillippines_Customer.php" class="check-btn">Download Documents</a>
<?php else: ?>
    <a href="/payments/payment.php?country=phillippines&visa_type=eligibility_check" class="check-btn">Download Documents</a>
<?php endif; ?>
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="/payments/payment.php?country=phillippines&visa_type=tourist_01"><button class="apply-button">Apply Now for $72.41 (₹5,720 + ₹499)</button></a>
                    <?php else: ?>
                        <a href="/payments/payment.php?country=phillippines&visa_type=tourist_01&redirect_to=/php/phillippines.php"><button class="apply-button">Apply Now for $72.41 (₹5,720 + ₹499)</button></a>
                    <?php endif; ?>
    </div>
