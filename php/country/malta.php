...
?>
    ...
    <a href="/payments/payment.php?country=malta&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php else: ?>
    <p><small>Please <a href="/php/login.php?redirect_to=/php/malta.php" class="login-link">login</a> to proceed with payment</small></p>
    <a href="/payments/payment.php?country=malta&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php endif; ?>
            </div>
        </div>
    ...
    <section class="document-checklist">
        <div class="container">
             <div class="label-container">
               ...
               <?php if (isset($_SESSION['user_id'])): ?>
    <a href="../php/Malta_Customer.php" class="check-btn">Download Documents</a>
<?php else: ?>
    <a href="/payments/payment.php?country=malta&visa_type=eligibility_check" class="check-btn">Download Documents</a>
<?php endif; ?>
        ...
        <div class="container">
            ...
            <div class="visa-card">
                ...
                <div class="visa-action">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="/payments/payment.php?country=malta&visa_type=tourist"><button class="start-btn">Apply Now</button></a>
                    <?php else: ?>
                        <a href="/payments/payment.php?country=malta&visa_type=tourist&redirect_to=/php/malta.php"><button class="start-btn">Apply Now</button></a>
                    <?php endif; ?>
                </div>
            </div>
...
<div class="price">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="/payments/payment.php?country=malta&visa_type=business"><button class="start-btn">Apply Now</button></a>
                    <?php else: ?>
                        <a href="/payments/payment.php?country=malta&visa_type=business&redirect_to=/php/malta.php"><button class="start-btn">Apply Now</button></a>
                    <?php endif; ?>
                </div>
            </div>
