...
<?php endif; ?>
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="/payments/payment.php?country=south_korea&visa_type=tourist_01"><button class="apply-button">Apply Now for $81.55 (₹6500 + ₹499)</button></a>
                    <?php else: ?>
                        <a href="/payments/payment.php?country=south_korea&visa_type=tourist_01&redirect_to=/php/south_korea.php"><button class="apply-button">Apply Now for $81.55 (₹6500 + ₹499)</button></a>
                    <?php endif; ?>
    </div>
