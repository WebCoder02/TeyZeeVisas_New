...
?>
    ...
    <a href="/payments/payment.php?country=georgia&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php else: ?>
    <p><small>Please <a href="/php/login.php?redirect_to=/php/georgia.php" class="login-link">login</a> to proceed with payment</small></p>
    <a href="/payments/payment.php?country=georgia&visa_type=eligibility_check"><button id="check-now" class="check-btn">Check Eligibility - Pay ₹499</button></a>
<?php endif; ?>
            </div>
        </div>
...
<?php else: ?>
    <a href="/payments/payment.php?country=georgia&visa_type=eligibility_check" class="check-btn">Download Documents</a>
<?php endif; ?>
    ...
    <h2 class="visa-information-title">eVisa Information</h2>
        ...
        <div class="visa-cards-grid">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
            <a href="/payments/payment.php?country=georgia&visa_type=tourist_single/multiple"><button class="apply-button">Apply Now for $21 (₹1800 + ₹499)</button></a>
        <?php else: ?>
            <a href="/payments/payment.php?country=georgia&visa_type=tourist_single/multiple&redirect_to=/php/georgia.php"><button class="apply-button">Apply Now for $21 (₹1800 + ₹499)</button></a>
        <?php endif; ?>
            </div>
        </div>
    </section>
